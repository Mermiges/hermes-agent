...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("harness", "Plan a Family Ant harness workflow from a client request",
               "Family Ant", gateway_only=True, args_hint="<request>"),
    CommandDef("go", "Execute the saved Family Ant harness plan",
               "Family Ant", gateway_only=True),
    CommandDef("answer", "Answer pending Family Ant harness plan questions",
               "Family Ant", gateway_only=True, args_hint="<text>"),
    CommandDef("brain", "Show or switch the Family Ant Hermes router brain",
               "Family Ant", gateway_only=True, args_hint="[codex|qwopus_boner|qwopus_fart]"),
    CommandDef("hstatus", "Show Family Ant harness fleet and orchestration status",
               "Family Ant", gateway_only=True),
